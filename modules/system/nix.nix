{ ... }: {
 ...
 nix.settings = {
      ...
      # Тайм-аут на установку соединения с substituter. Маленькое
      # значение хорошо для «явно дохлый зеркал», но cachix-у иногда
      # надо больше времени на TLS-handshake — 5s срезает его на лету.
      connect-timeout = 30;
    };
